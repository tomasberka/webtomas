...
export default async function ServicePage({ params }: ServicePageProps) {
    ...
    // For English, we need to match the slug which might be in services/ or just the slug itself
    // In services-en.json, slugs are like "reels-packages" OR "services/creative-production"
    // The folder structure is /en/services/[slug], so we check both
