...
import { Clapperboard, Smartphone, Calendar, Radio, MonitorPlay, Globe, User, Mic } from "lucide-react";
            ...
            <section className="py-12 md:py-16">
                <Container>
                    <div className="text-center mb-10">
                        <h2 className="text-3xl md:text-4xl font-black mb-3">Two areas, one person</h2>
                        <p className="text-muted-foreground text-lg">Pick your path — or let's talk about combining both.</p>
                    </div>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-card border rounded-2xl p-8 flex flex-col gap-4 hover:border-primary/50 transition-all">
                            <div className="text-4xl">🎬</div>
                            <h3 className="text-2xl font-black">Cameraman &amp; Event Video</h3>
                            <p className="text-muted-foreground">Conferences, corporate events, brand films. Based in Prague, works across Europe. Bilingual EN/CZ.</p>
                            <ul className="space-y-1.5 text-sm flex-1">
                                <li className="flex items-center gap-2"><span className="text-primary">✓</span> 150+ events filmed</li>
                                <li className="flex items-center gap-2"><span className="text-primary">✓</span> DaVinci Resolve post-production</li>
                                <li className="flex items-center gap-2"><span className="text-primary">✓</span> Results within 5 days</li>
                            </ul>
                            <Link href="/reels-packages"><Button className="w-full font-bold mt-2">See Packages</Button></Link>
                        </div>
                        <div className="bg-card border rounded-2xl p-8 flex flex-col gap-4 hover:border-primary/50 transition-all">
                            <div className="text-4xl">🎭</div>
                            <h3 className="text-2xl font-black">UGC Creator &amp; Actor</h3>
                            <p className="text-muted-foreground">Authentic UGC content for brands. With acting background — real emotion, no stiffness.</p>
                            <ul className="space-y-1.5 text-sm flex-1">
                                <li className="flex items-center gap-2"><span className="text-primary">✓</span> From €100 per video</li>
                                <li className="flex items-center gap-2"><span className="text-primary">✓</span> English &amp; Czech</li>
                                <li className="flex items-center gap-2"><span className="text-primary">✓</span> Fast turnaround, usage rights included</li>
                            </ul>
                            <Link href="/ugc-creator"><Button variant="outline" className="w-full font-bold mt-2">UGC Options</Button></Link>
                        </div>
                    </div>
                </Container>
            </section>
