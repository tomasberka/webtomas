                    ...
                    <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/jajsemtomas.cz/" aria-label="Follow on Instagram" target="_blank" rel="noopener noreferrer" className="hover:text-primary inline-flex items-center gap-1">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/berkatomas" aria-label="Connect on LinkedIn" target="_blank" rel="noopener noreferrer" className="hover:text-primary inline-flex items-center gap-1">
